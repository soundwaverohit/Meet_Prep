...
| `data/support_policy.md` | The decision policy: 7 numbered rules covering security escalation, when to ask before looking things up, not repeating failed fixes, confirmation-before-action, and refund thresholds. Read it before writing your system prompt. |
